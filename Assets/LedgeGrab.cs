...
public class LedgeGrab : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        greenBox = Physics2D.OverlapBox(new Vector2(transform.position.x + (redXOffset * transform.localScale.x), transform.position.y), new Vector2(redXSize, redYSize), 0, ledge);

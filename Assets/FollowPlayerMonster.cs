...
public class FollowPlayerMonster : StateMachineBehaviour
{
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        if(MonsterFollow.Player!=null)
        {
            ...
            if (MonsterFollow.Player.GetComponent<Rigidbody2D>().velocity.x<0 && animator.transform.position.x > MonsterFollow.Player.transform.position.x)
            {

...
[Observer(AssetType = Asset.MONOBEHAVIOR, EntityType = typeof(PickableItems), SubjectType = typeof(OpenWares), ContextType = typeof(bool))]
[Observer(AssetType = Asset.MONOBEHAVIOR, EntityType = typeof(GameStateConsumer), SubjectType = typeof(OpenWares), ContextType = typeof(GenericStateBundle<GameStateBundle>))]

...
public class CheckPointActionListener : MonoBehaviour, IObserver<Checkpoint>
{
    ...
    public async void OnNotify(Checkpoint data, ObserverContext context, SemaphoreSlim semaphoreSlim, CancellationToken cancellationToken, params object[] optional)
    {

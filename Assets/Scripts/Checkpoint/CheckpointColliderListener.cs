...
public class CheckpointColliderListener : MonoBehaviorScene, INotify<Player>, INotify<EntityPoolManager>, INotify<GameStateManager>
{
    ...
    public IEnumerator Notify(EntityPoolManager value)
    {
        ...
        StartCoroutine(BaseScene.WaitForSceneUtils());

        CheckPointsSO = BaseScene.GetSceneUtils().GetFromEntityPoolManager<CheckPoints>(EntityPoolManagerInstance, CHECKPOINTS_KEY);

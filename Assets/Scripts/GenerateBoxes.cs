...
public class GenerateBoxes : MonoBehaviour
{
    ...
    public void GenerateInventory(int _Size, int _startX, int _startY, int _increment, int _decrement, ref Queue<GameObject> inventoryList, ref GameObject PanelObject)
    {

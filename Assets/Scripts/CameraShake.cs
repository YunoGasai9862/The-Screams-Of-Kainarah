...
[Observer(AssetType = Annotations.Enums.Asset.MONOBEHAVIOR, ObserverType = typeof(CameraShake), SubjectType = typeof(AsyncCoroutine), ContextType = typeof(AsyncCoroutine))]
[Observer(AssetType = Annotations.Enums.Asset.MONOBEHAVIOR, ObserverType = typeof(CameraShake), SubjectType = typeof(EmitAttackAnimationStateConsumer), ContextType = typeof(GenericStateBundle<EmitAnimationStateBundle<bool>, AttackState>))]

...
[Observer(AssetType = Asset.MONOBEHAVIOR, SubjectType = typeof(CustomLightProcessing), EntityType = typeof(CandleLightPackageGenerator), ContextType = typeof(LightPackage))]
[Observer(AssetType = Asset.MONOBEHAVIOR, SubjectType = typeof(CustomLightProcessing), EntityType = typeof(CelestialBodiesLightPackageGenerator), ContextType = typeof(LightPackage))]
[Observer(AssetType = Asset.MONOBEHAVIOR, SubjectType = typeof(CustomLightProcessing), EntityType = typeof(AsyncCoroutine), ContextType = typeof(AsyncCoroutine))]
